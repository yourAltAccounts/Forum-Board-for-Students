...
public class ControllerUserUpdate {
	...
	**********************************************************************************************/
	 ...
	 * 
	 * <p> Description: This method is called when the user has clicked on the logout button.
	 * It logs out the current user and returns to the login page where existing users can 
	 * log in or potential new users with an invitation code can start the process of setting 
	 * up an account.
	 */
	...
	protected static void goToUserHomePage(Stage theStage, User theUser) {
		...
		case 1:
			...
			break;
		case 2:
			guiRole1.ViewRole1Home.displayRole1Home(theStage, theUser, applicationMain.FoundationsMain.database); //added database
			break;
		case 3:
